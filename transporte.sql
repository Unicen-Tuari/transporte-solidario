...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-12-2016 a las 00:21:29
...
(8, 'Asignar Transportista', 'asignar', 'ViajesController', '2016-12-10 03:00:00', '2016-12-10 03:00:00', 'glyphicon glyphicon-thumbs-up');
...
--
-- Volcado de datos para la tabla `ofrecido`
--

INSERT INTO `ofrecido` (`id_ofrecimiento`, `id_viaje`, `id_transportista`, `oferta_activa`) VALUES
(1, 1, 5, 1),
(2, 2, 5, 1),
(3, 6, 5, 1),
(4, 1, 6, 1),
...
(2, 'Mesa Solidaria', 'mesasolidaria@lala.com', '$2a$06$E/WR4ekkv7YuZFJpFbak8.qayik9YrtWuGVO4zMQefgpLg5KCpWRW', 'miramelamesa', 'que mesasa', 'son un para de chavones/as que hacen cosas por la gente', '24324234', '', '2016-11-16', 'img/logo_Mesa.png', 3),
(3, 'Banco de alimentos', 'bancoalimentos@gmail.com', '$2a$06$E/WR4ekkv7YuZFJpFbak8.qayik9YrtWuGVO4zMQefgpLg5KCpWRW', 'bancoalimentos', 'www.bankfood.com', 'El citibank del morfi', '3247932864', 'ONG', '2016-11-16', 'img/BancoAlimentos.jpg', 3),
(4, 'reinventar', 'teinventedenuevo@gmail.com', '$2a$06$E/WR4ekkv7YuZFJpFbak8.qayik9YrtWuGVO4zMQefgpLg5KCpWRW', 'reinventarTandil', 'www.reinventar.com.ar', 'hacen algo', '23212', 'ONG', '2016-11-15', 'img/reinventar.jpg', 3),
(5, 'trasnp1', 'jajaja@jaja.com', '$2a$06$E/WR4ekkv7YuZFJpFbak8.qayik9YrtWuGVO4zMQefgpLg5KCpWRW', 'jsdhjgsd', 'sdaadsads', NULL, '23456', 'transportista', '2016-12-10', NULL, 4),
(6, 'expreso lalala', 'jijiji@gmail.com', '$2a$06$E/WR4ekkv7YuZFJpFbak8.qayik9YrtWuGVO4zMQefgpLg5KCpWRW', 'lshdasj', 'expresolalala.com', NULL, '234567', 'transportista', '2016-12-09', NULL, 4),
(7, 'expreso sarasa', 'sarasa@gmail.com', '$2a$06$E/WR4ekkv7YuZFJpFbak8.qayik9YrtWuGVO4zMQefgpLg5KCpWRW', 'sarasa', 'sarasa.com', NULL, '876543', 'transportista', '2016-12-07', NULL, 4);
...
CREATE TABLE `viajesolidario` (
  ...
  `Transp_asignado` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `viajesolidario` (`id_viaje`, `origen`, `destino`, `fecha_creac`, `id_ong`, `habilitado`, `frecuencia`, `alto`, `ancho`, `peso`, `descripcion`, `Transp_asignado`) VALUES
(1, 'Tandil', 'Azul', '2016-11-07', 2, 1, 'mensual', 1, 4, 25, 'proyecto recuperacion de botellas', 0),
(2, 'Tandil', 'Olavarria', '2016-11-07', 2, 1, 'Semanal', 2, 2, 34, 'proyecto bolsas y pet', 0),
(5, 'Tandil', 'Juarez', '2016-11-07', 3, 1, '15 dias', 1.4, 2.2, 66, 'distribucion a sucursal juarez', 0),
(6, 'Tandil', 'Capital Federal', '2016-11-07', 4, 1, 'Mensual', 1, 1.5, 33, 'insumos proyecto pymes pibes', 0),
(7, 'Azul', 'Tandil', '2016-11-19', 2, 1, 'Mensual', 30, 30, 10, 'traslado de botellas de acopio azul a tandil', 0),
(8, 'Tandil', 'Mar del Plata', '2016-11-24', 3, 1, 'semanal', 33, 22, 222, 'Traslado de insumos a sucursal Mar del plata', 0);
...
--
-- Indices de la tabla `ofrecido`
--
ALTER TABLE `ofrecido`
  ADD KEY `id_ofrecimiento` (`id_ofrecimiento`);
...
--
-- AUTO_INCREMENT de la tabla `ofrecido`
--
ALTER TABLE `ofrecido`
  MODIFY `id_ofrecimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
